        ...
        <div className="rise-in relative w-full max-w-md text-center">
          <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-6 backdrop-blur-sm sm:p-8">
            ...
            <p className="mt-3 text-sm text-white/50">
              Token reset password tidak ditemukan. Pastikan kamu klik link dari
              email, atau request ulang.
            </p>
            <Link
              to="/auth/forgot-password"
              className="mt-6 flex w-full items-center justify-center gap-2 rounded-xl bg-white px-6 py-3.5 text-sm font-bold text-[#0a0a0a] no-underline"
            >
              Request Ulang
            </Link>
          </div>
